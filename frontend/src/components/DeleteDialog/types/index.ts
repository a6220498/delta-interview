/**
 * The public type surface of `DeleteDialog`.
 *
 ...
 * to an `import './delete-dialog'` that the bundler could not resolve.
 */
export type { DeleteDialogEmits, DeleteDialogExposed } from './delete-dialog'
